...
const features = [
  {
    ...
    description: '카드, 현금, 배달 앱 등 모든 결제 수단의 매출을 실시간으로 집계하여 한눈에 보여줍니다. 시간대별, 취소율 분석, 가맹점별 매출관리로 수익성을 극대화하세요.',
    image: '/gifs/dashboard-preview.gif',
  ...
  },
  {
    ...
    description: '커스텀이 가능한 포스기와 일반 키오스크, 프론트 키오스크를 제공합니다. 별도의 프로그램 없이 한번에 이용하세요.',
