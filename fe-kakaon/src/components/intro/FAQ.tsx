...
const faqs = [
  {
    ...
    answer: '카카온은 여러 결제 채널에서 발생하는 매출 데이터를 통합하여 AI가 분석하고, 이상 거래를 실시간으로 탐지해주는 가맹점 매출 관리 플랫폼입니다.',
  },
  {
    question: '서비스 이용 요금은 어떻게 되나요?',
    answer: '기본적인 매출 조회 및 분석 기능은 무료로 제공됩니다. 이상거래 탐지, 포스기, 키오스크 시스템도 무료로 제공됩니다.',
  },
  {
    question: '어떤 결제 수단을 연동할 수 있나요?',
    answer: '대부분의 카드사, PG사, 배달 앱 등과 연동 할 예정입니다. 자세한 지원 목록은 고객센터로 문의해주세요.',
  },
  {
